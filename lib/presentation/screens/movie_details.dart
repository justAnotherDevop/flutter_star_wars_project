                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return switch (currentRowItem) {
                        CharactersItem() => CharactersRow(currentRowItem: currentRowItem),
                        PlanetsItem() => PlanetsRow(currentRowItem: currentRowItem),
                        StarshipsItem() => StarshipsRow(currentRowItem: currentRowItem),
                        VehiclesItem() => VehiclesRow(currentRowItem: currentRowItem),
                        SpeciesItem() => SpeciesRow(currentRowItem: currentRowItem),
                      };
                    },
                  );
                case Status.error:
...
class SpeciesRow extends StatelessWidget {
  const SpeciesRow({
    super.key,
    required this.currentRowItem,
  });

  final SpeciesItem currentRowItem;
...
class VehiclesRow extends StatelessWidget {
  const VehiclesRow({
    super.key,
    required this.currentRowItem,
  });

  final VehiclesItem currentRowItem;
...
class StarshipsRow extends StatelessWidget {
  const StarshipsRow({
    super.key,
    required this.currentRowItem,
  });

  final StarshipsItem currentRowItem;
...
class PlanetsRow extends StatelessWidget {
  ...
  final PlanetsItem currentRowItem;
...
class CharactersRow extends StatelessWidget {
  ...
  final CharactersItem currentRowItem;
